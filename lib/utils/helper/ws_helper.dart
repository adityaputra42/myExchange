import 'package:crypto_app/data/model/order/order.dart';
...
class WsHelper {
  ...
  static List<OrderModel> insertOrUpdate(
      List<OrderModel> openOrdersList, order) {
    var id = order['id'];
      ...
      case 'wait':
        ...
        if (index == -1) {
          var newOpenOrder = OrderModel(
            ...
            createdAt: createdAt,
            originVolume: order['origin_volume'],
